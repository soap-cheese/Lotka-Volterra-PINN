...
class Net(nn.Module):
    def __init__(self, hidden_size=16, activation=nn.Tanh):
        super().__init__()
...
if __name__ == '__main__':
    ...
    if train_switch:
        ...
        while 1:
            ...
            plot_loss(loss_bc=loss_bc_arr, loss_pde=loss_pde_arr,
                      difference_with_numerical=kutta_diff_arr, loss=loss_arr)
